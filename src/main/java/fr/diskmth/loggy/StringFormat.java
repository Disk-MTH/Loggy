...
public enum StringFormat
{
    ...
    public static String format(String message, StringFormat... formats)
    {
        ...
        Arrays.asList(formats).forEach(format -> formattedMessage.append(format.getAnsiCode()));
        return formattedMessage.append(message).append(StringFormat.RESET.getAnsiCode()).toString();
    }
